...
IF your interested in using promptui to extend an existing command line app, here is one very flexible [example of how you can use it with cobra](https://github.com/jayunit100/promptui-cobra-example).
